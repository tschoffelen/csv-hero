...
export const transformWithJavascript = (rows, options, setAttributes) => {
  try {
    ...
    console.error(`Failed executing script: `, e);
...
export const JavascriptTransformControl = ({ options, setOptions }) => (
...
export const JavascriptTransform = {
  ...
  controls: ({ options, setOptions }) => (
    <JavascriptTransformControl options={options} setOptions={setOptions} />
  ),
};
